...
import {rollDie} from './pokerDiceRoller.js';
...
main();
/**
 In the case of a rejected promise, dice that have not yet finished their roll continue
  to do so because `Promise.all` waits for all promises to settle (either resolved or rejected).
   However, it immediately returns a rejected promise once any of the input promises is rejected,
    without cancelling the remaining asynchronous operations. Therefore, the rolling of other dice 
    continues even after one die rolls off 
 the table.
 */